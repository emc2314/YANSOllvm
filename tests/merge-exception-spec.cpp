...
// SingleSource/Regression/C++/EH/exception_spec_test.cpp. MergePass must not rewrite function-address uses such as
// std::set_terminate/std::set_unexpected handler pointers.
